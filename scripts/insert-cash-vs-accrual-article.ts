...
2. **Calculate the adjustment** — the IRS requires a "Section 481(a) adjustment" to prevent income from being double-counted or missed
...
Every payment should be tied to a professional invoice with a unique number, date, and itemized description. Use our **[free invoice generator](/)** to create consistent, trackable invoices for every project. Read our guide on [how to write a freelance invoice](/blog/how-to-write-invoice-freelance-work) for a complete walkthrough.
