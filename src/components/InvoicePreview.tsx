    ...
    <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-4">
        <div className="flex justify-between items-start">
          ...
          <div className="text-right">
            <p className="text-2xl font-bold text-white tracking-wide">INVOICE</p>
      ...
      <div className="p-6 space-y-5">
        ...
        <div className="grid grid-cols-3 gap-4 text-xs">
          <div>
            <p className="font-semibold text-gray-500 uppercase tracking-wider mb-1">From</p>
          ...
          <div className="text-right">
            <div className="space-y-1">
              ...
              <div>
                <p className="font-semibold text-gray-500 uppercase tracking-wider">Due Date</p>
                <p className="text-gray-900">{data.dueDate || '—'}</p>
              </div>
              <div>
                <p className="font-semibold text-gray-500 uppercase tracking-wider">Terms</p>
          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="bg-gray-50 text-gray-500 uppercase tracking-wider">
                ...
                <th className="text-center py-2 px-3 font-semibold w-16">Qty</th>
